...
La IA puede consultar Internet con consentimiento explicito por mensaje y permiso general activado en Ajustes. La respuesta web devuelve fuentes y enlaces externos, esta limitada por tiempo, tamano, frecuencia y dominios publicos, y nunca recibe contexto personal. Si no esta disponible, responde con una alternativa basada en la aplicacion.
