...
export function AIWorkspace({ initialChats, initialChatPagination, initialActiveId, initialMessages, initialMessagePagination, initialSettings, contextOptions }: {
  ...
  async function sendMessage(content: string) {
    ...
    try {
      ...
      const response = await fetch(`/api/ai/chats/${chatId}/messages`, { method: "POST", headers: { "Content-Type": "application/json" }, body: JSON.stringify({ content, requestId: messageRequestId, context, usePersonalContext, allowInternet }) });
