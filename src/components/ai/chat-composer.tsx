...
export function ChatComposer({ disabled, contextEnabled, usePersonalContext, canUseInternet, allowInternet, uploading = false, onPersonalContextChange, onAllowInternetChange, onUpload, onSend }: {
  disabled: boolean;
